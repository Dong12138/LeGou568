...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    ...
    CGFloat toolViewH = [UIScreen mainScreen].bounds.size.height;
    CGFloat toolViewY ;
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    //
    datePicker.frame=CGRectMake(0, [UIScreen mainScreen].bounds.size.height-216,[UIScreen mainScreen].bounds.size.width, datePicker.frame.size.height);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, [UIScreen mainScreen].bounds.size.height-ZHToobarHeight-216,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
    //_pickerView.frame =CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, _pickeviewHeight);
}
