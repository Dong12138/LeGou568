                   ...
                   type:(FVAlertType)type
{
    ...
    //CGRect windowRect = CGRectMake(<#CGFloat x#>, <#CGFloat y#>, <#CGFloat width#>, <#CGFloat height#>)
    ...
    UIView *shadowView = [[UIView alloc] initWithFrame:CGRectMake(windowRect.size.width/2 - width/2,
                                                                  windowRect.size.height - height/2-120,
                                                                  width, height)];
...
+ (UIView *)contentViewFromType:(FVAlertType)type {
    ...
    switch (type) {
        ...
        {
            content.frame = CGRectMake(0, kInsetValue, kOtherIconsSize, kOtherIconsSize);
            content.image = [UIImage imageNamed:@""];
        }
            break;
        default:
